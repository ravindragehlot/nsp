<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
			...
			<div class="radio">
                <label>
                    <input type="radio" name="admin_type" value="ic" required="" <?php echo ($edit && $admin_account['admin_type'] =='ic') ? "checked": "" ; ?>/> Internal Comittee
                </label>
            </div>
			<div class="radio">
                <label>
                    <input type="radio" name="admin_type" value="lc" required="" <?php echo ($edit && $admin_account['admin_type'] =='lc') ? "checked": "" ; ?>/> Local Comittee
                </label>
            </div>
        </div>
    </div>
